...
function setup() {
	...
	stone1 = new Stone(235, 600, 40)
	

	mango1 = new Mango(1200, 300, 40)
	mango2 = new Mango(1300, 300, 40)
	mango3 = new Mango(1400, 300, 40)
	mango4 = new Mango(1500, 300, 40)
	mango5 = new Mango(1450, 200, 40)
	mango6 = new Mango(1350, 200, 40)
